/*
  ...
  1. New Data
    - Populates menu_sections, menu_categories, and menu_items tables with data
    - Includes multilingual content (English, Greek, Turkish)
    - Organizes menu by sections (Breakfast, Beach & Snack, Restaurant)
    - Includes proper categorization and display order
